...
CREATE TABLE IF NOT EXISTS ims.items(id int PRIMARY KEY auto_increment, name varchar(40), price DEC(7,2));
CREATE TABLE IF NOT EXISTS ims.orders(id int PRIMARY KEY auto_increment, customer_id_fk int NOT NULL, total_price DEC(7,2), FOREIGN KEY (customer_id_fk) REFERENCES customers(id));
